...
import ru.ekipogh.sud.ImageRenderer;
import ru.ekipogh.sud.Script;
import ru.ekipogh.sud.SudTreeNode;
...
class InventoryFrame extends JFrame {
    ...
    private static final String ONDROP = "_onDrop";
    private static final String ONEQUIP = "_onEquip";
    private static final String ONUNEQUIP = "_onUnequip";
